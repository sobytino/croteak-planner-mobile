CroTeak Planner MOBILE BUILD070 PWA
...
- CroTeak_Planner_MOBILE_BUILD070.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build070-v1
