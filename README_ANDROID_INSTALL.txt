CroTeak Planner MOBILE BUILD082 PWA
...
- CroTeak_Planner_MOBILE_BUILD082.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build082-v1
