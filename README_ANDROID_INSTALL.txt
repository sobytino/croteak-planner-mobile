CroTeak Planner MOBILE BUILD047 PWA
...
- CroTeak_Planner_MOBILE_BUILD047.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build047-v1
