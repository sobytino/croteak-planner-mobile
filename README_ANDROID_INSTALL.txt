CroTeak Planner MOBILE BUILD079 PWA
...
- CroTeak_Planner_MOBILE_BUILD079.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build079-v1
