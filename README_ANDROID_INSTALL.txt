CroTeak Planner MOBILE BUILD036 PWA
...
- CroTeak_Planner_MOBILE_BUILD036.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build036-v1
