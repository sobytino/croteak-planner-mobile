CroTeak Planner MOBILE BUILD058 PWA
...
- CroTeak_Planner_MOBILE_BUILD058.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build058-v1
