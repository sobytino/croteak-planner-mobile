CroTeak Planner MOBILE BUILD050 PWA
...
- CroTeak_Planner_MOBILE_BUILD050.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build050-v1
