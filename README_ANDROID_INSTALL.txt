CroTeak Planner MOBILE BUILD045 PWA
...
- CroTeak_Planner_MOBILE_BUILD045.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build045-v1
