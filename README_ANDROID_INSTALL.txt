CroTeak Planner MOBILE BUILD080 PWA
...
- CroTeak_Planner_MOBILE_BUILD080.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build080-v1
