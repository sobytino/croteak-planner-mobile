CroTeak Planner MOBILE BUILD052 PWA
...
- CroTeak_Planner_MOBILE_BUILD052.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build052-v1
