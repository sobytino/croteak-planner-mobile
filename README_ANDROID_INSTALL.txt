CroTeak Planner MOBILE BUILD042 PWA
...
- CroTeak_Planner_MOBILE_BUILD042.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build042-v1
