CroTeak Planner MOBILE BUILD048 PWA
...
- CroTeak_Planner_MOBILE_BUILD048.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build048-v1
