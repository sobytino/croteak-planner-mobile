CroTeak Planner MOBILE BUILD072 PWA
...
- CroTeak_Planner_MOBILE_BUILD072.html = isti app file s build imenom
...
- service worker cache dignut na croteak-mobile-build072-v1
